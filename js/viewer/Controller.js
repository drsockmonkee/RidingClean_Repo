//Map Object and collection of objects for the application

define([
    'esri/map', 'dojo/dom', 'dojo/dom-style', 'dojo/dom-geometry', 'dojo/dom-class',
	'dojo/on', 'dojo/_base/array', 'dijit/layout/BorderContainer', 'dijit/layout/ContentPane',
	'gis/dijit/FloatingTitlePane', 'dojo/_base/lang', 'dojo/text!./templates/mapOverlay.html',
	'gis/dijit/FloatingWidgetDialog', 'put-selector', 'dojo/aspect', 'dojo/has',
	'dojo/topic', 'esri/dijit/PopupMobile', 'dijit/Menu', 'esri/IdentityManager'
], function (
    Map, dom, domStyle, domGeom, domClass, on, array, BorderContainer, ContentPane, FloatingTitlePane,
    lang, mapOverlay, FloatingWidgetDialog, put, aspect, has, topic, PopupMobile, Menu)
{
    return {
        //legendLayerInfos:[],
        //identifyLayerInfos:[],
        ...
        startup: function (config) {
            ...
            this.config = config;
            this.mapClickMode = {
                //curent: config.defaultMapClickMode,
        ...
        initMap: function () {
            ...
            //hits the loop loading the widgets to the page.
            this.initWidgets();
        ...
        initWidgets: function () {                       
            var widgets = [], paneWidgets;
            console.log('beginning the widget loop');
        ...
        //extra management of splitters required
        //are not in the center of the map pane
